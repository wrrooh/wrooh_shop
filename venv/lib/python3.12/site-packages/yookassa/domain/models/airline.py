...
class Airline(BaseObject):
    ...
    def passengers(self, value):
        if isinstance(value, list):
            ...
            if len(value) < 0:
                raise ValueError("Invalid value for `passengers`, number of items must be greater than or equal to `0`")  # noqa: E501
    ...
    def legs(self, value):
        if isinstance(value, list):
            ...
            if len(value) < 0:
                raise ValueError("Invalid value for `legs`, number of items must be greater than or equal to `0`")  # noqa: E501
