...
ROOT_URLCONF = 'wrooh.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'wrooh' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'wrooh.wsgi.application'
...
# YOOKASSA_SHOP_ID = env('YOKASSA_SHOP_ID')
# YOOKASSA_SECRET_KEY = env('YOKASSA_SECRET_KEY')
YOOKASSA_SHOP_ID = '123456'
YOOKASSA_SECRET_KEY = 'test_12345'
